...
export const GRAPH_API_URL = 'https://api.thegraph.com/subgraphs/name/seniorblockchaindev/epicbeast'
...
export const getIpfsUrl = (id: number): string => {
  ...
  return `https://api.epicbeast.io/metadata/epicbeast/${id}.png`
}